...
/** 滑块 */
@property (nonatomic, strong) CXSliderButton *sliderBtn;
...
- (CXSliderButton *)sliderBtn {
    if (_sliderBtn == nil) {
        
        _sliderBtn = [CXSliderButton new];
//        _sliderBtn.backgroundColor = [UIColor whiteColor];
//        取消背景颜色 恢复图片设置
        _sliderBtn.backgroundColor = [UIColor colorWithHexString:@"#43a5fe"];
        _sliderBtn.layer.cornerRadius = 7;
...
@interface CXSliderButton()

@property (nonatomic, strong) UIActivityIndicatorView *indicatorView;

@end

@implementation CXSliderButton
